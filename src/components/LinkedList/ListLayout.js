          ...
          <div className="command-parent">
            <CommandContainer>
              <Enqueue
                ...
                note={'Type an element and press Insert to add to the end of the linked list'}
                />
              ...
              <Enqueue
                ...
                note={'Type an element and press Insert to add to the front of the linked list'}
                />
                
                <SingleButton
                  label={"Remove an element from the end of the Linked List"}
                  btn={"Delete"}
                  note={"Delete will eliminate the last element of the Linked List"}
                ...
                <SingleButton
                  ...
                  btn={"Delete"}
                  note={"Delete will eliminate the first element of the Linked List"}
